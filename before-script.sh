...
# --Custom--
# echo $(cat Unity_v2018.ulf) > Unity_lic.ulf
# sed -i 's/\r$//' Unity_lic.ulf 
# echo $(cat Unity_lic.ulf) > /root/.local/share/unity3d/Unity/Unity_lic.ulf

cp Unity_lic.ulf /root/.local/share/unity3d/Unity/Unity_lic.ulf
sed -i 's/\r$//' /root/.local/share/unity3d/Unity/Unity_lic.ulf
